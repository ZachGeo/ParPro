...
{	
	...
	// Στατικός τρόπος ανάθεσης πολυγραμμών στα νήματα. Το chunk δεν δηλώνετε, με αποτέλεσμα οι επαναλήψεις να χωρίζονται σε κομμάτια που είναι περίπου ίσα σε μέγεθος. Επίσης, το πρότυπο OpenMP απαιτεί ο βρόχος να είναι σε "κανονική μορφή". Οπότε στον έλεγχο των επαναλήψεων αλλάξαμε το σύμβολο "!=" σε "<".
